...
namespace AM.ApplicationCore.domain
{
    public static class TestData
    {
        ...
        public static Plane Airbusplane = new Plane { PlaneType = PlaneType.AIRBUS, Capacity = 250, ManufactureDate = new DateTime(2020, 11, 11), Aireline ="azert"};
        // Staffs
        ...
        public static Staff hostess1 = new Staff { FullName = new FullName { FirstName = "hostess1", LastName = "hostess1" }, EmailAddress = "hostess1.hostess1@gmail.com", BirthDate = new DateTime(1995, 01, 01), EmploymentDate = new DateTime(2020, 01, 01), Salary = 999,PassportNumber="3" };
       ...
       ,
        ...
        public static Flight flight2 = new Flight { FlightDate = new DateTime(2022, 01, 03, 21, 10, 10), Destination = "Paris", EffectiveArrival = new DateTime(2022, 02, 01, 23, 10, 10), EstimatedDuration = 105, Plane = BoingPlane };
        ...
        public static Flight flight6 = new Flight { FlightDate = new DateTime(2022, 06, 01, 20, 10, 10), Destination = "Lisbonne", EffectiveArrival = new DateTime(2022, 06, 01, 22, 30, 10), EstimatedDuration = 200, Plane = Airbusplane ,Departure ="azerty" };
